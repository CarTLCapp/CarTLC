...
class CheckBoxItemViewMvcImpl(
        inflater: LayoutInflater,
        container: ViewGroup?
) : ViewMvcImpl(), CheckBoxItemViewMvc {

    override val rootView: View = inflater.inflate(R.layout.mainlist_item_check_box, container, false)

    private val itemView = findViewById<CheckBox>(R.id.item)
    ...
    override fun bind(position: Int, item: String, listener: CheckBoxItemViewMvc.Listener) {
