...
public abstract class ColorModel implements Transparency {
    ...
    protected ColorModel(int pixel_bits, int[] bits, ColorSpace cspace, boolean hasAlpha,
        ...
        if (pixel_bits < 1) {
            ...
            throw new IllegalArgumentException("awt.26B"); //$NON-NLS-1$
        }

        if (bits == null) {
            // awt.26C=bits is null
            throw new NullPointerException("awt.26C"); //$NON-NLS-1$
        }
        ...
        for (int element : bits) {
            if (element < 0) {
                ...
                throw new IllegalArgumentException("awt.26D"); //$NON-NLS-1$
            }
            sum += element;
        }
        ...
        if (sum < 1) {
            ...
            throw new NullPointerException("awt.26E"); //$NON-NLS-1$
        }

        if (cspace == null) {
            // awt.26F=The cspace is null
            throw new IllegalArgumentException("awt.26F"); //$NON-NLS-1$
        }

        if (transparency < Transparency.OPAQUE || transparency > Transparency.TRANSLUCENT) {
            // awt.270=The transparency is not a valid value
            throw new IllegalArgumentException("awt.270"); //$NON-NLS-1$
        }
    ...
    public float[] getNormalizedComponents(Object pixel, float[] normComponents, int normOffset) {
        ...
        if (pixel == null) {
            ...
            throw new NullPointerException("awt.294"); //$NON-NLS-1$
        }
    ...
    public float[] getNormalizedComponents(int[] components, int offset, float normComponents[],
        ...
        if (bits == null) {
            // awt.26C=bits is null
            throw new UnsupportedOperationException("awt.26C"); //$NON-NLS-1$
        }
    ...
    public int[] getUnnormalizedComponents(float normComponents[], int normOffset,
        ...
        if (normComponents.length - normOffset < numComponents) {
            ...
            // than numComponents
            throw new IllegalArgumentException("awt.273"); //$NON-NLS-1$
        }
        ...
        if (components == null) {
            ...
            if (components.length - offset < numComponents) {
                ...
                // numComponents
                throw new IllegalArgumentException("awt.272"); //$NON-NLS-1$
            }
        }
    ...
    public int getComponentSize(int componentIdx) {
        ...
        if (componentIdx < 0 || componentIdx >= bits.length) {
            ...
            // less than zero
            throw new ArrayIndexOutOfBoundsException("awt.274"); //$NON-NLS-1$
        }
