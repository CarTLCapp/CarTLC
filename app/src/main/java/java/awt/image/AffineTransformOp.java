...
public class AffineTransformOp implements BufferedImageOp, RasterOp {
    ...
    public final Rectangle2D getBounds2D(Bitmap src) {
    ...
    public Bitmap createCompatibleDestImage(Bitmap src, ColorModel destCM) {
        ...
        if (dstWidth <= 0 || dstHeight <= 0) {
            ...
            // greater than 0
            throw new RasterFormatException(String.format("createCompatibleDestImage: illegal destination size: %g x %g " + dstWidth, dstHeight)); //$NON-NLS-1$
        }
